...
CREATE TABLE `explored` (
  ...
  `ExploredAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (`Username`) REFERENCES `user`(`Username`) ON DELETE CASCADE,
...
INSERT INTO `explored` (`Username`, `TrailID`, `ExploredAt`) VALUES
('kclark', 1, '2023-01-15 10:15:00'),
('kclark', 5, '2023-03-10 11:30:00'),
('kclark', 7, '2023-05-05 09:45:00'),
('jdoe', 2, '2023-06-20 12:00:00'),
('jdoe', 5, '2023-08-12 14:20:00'),
('jdoe', 8, '2023-10-01 13:15:00'),
('jdoe', 11, '2023-11-15 15:30:00'),
('jdoe', 14, '2024-07-18 16:10:00'),
('elliot_b', 2, '2023-02-08 08:30:00'),
('elliot_b', 4, '2023-04-01 09:00:00'),
('elliot_b', 6, '2023-06-01 10:00:00'),
('elliot_b', 8, '2023-08-01 11:00:00'),
('elliot_b', 9, '2023-10-01 12:00:00'),
('awelch', 1, '2023-03-01 07:45:00'),
('awelch', 3, '2023-05-01 08:15:00'),
('awelch', 7, '2023-07-01 09:30:00'),
('awelch', 10, '2023-09-01 10:45:00'),
('awelch', 15, '2023-11-01 11:30:00'),
('awelch', 19, '2024-01-01 12:15:00'),
('alana_s', 3, '2023-04-15 13:00:00'),
('alana_s', 5, '2023-06-15 14:00:00'),
('alana_s', 6, '2023-08-15 15:00:00'),
('alana_s', 7, '2024-06-10 16:00:00'),
('alana_s', 10, '2023-12-15 17:00:00'),
('alana_s', 11, '2024-02-15 18:00:00'),
('arthur_c', 1, '2023-01-05 06:30:00'),
('arthur_c', 4, '2023-03-05 07:00:00'),
('arthur_c', 6, '2023-05-05 08:00:00'),
('arthur_c', 7, '2023-07-05 09:00:00'),
('arthur_c', 8, '2023-09-05 10:00:00'),
('arthur_c', 9, '2024-08-22 11:00:00');
